...
public class JWTUtil {
    ...
    //6 validate userName in token and database, expDate --MANDATORY
//    public boolean validateToken(String token,//token username
//                                 String userName// database userName
//                                ){
//        String tokeUsername = getUsername(token);
//        return userName.equals(tokeUsername) && !isTokenExp(token);
//
//    }
